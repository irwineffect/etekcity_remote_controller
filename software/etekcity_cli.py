...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Command line interface for controlling etekcity remote controlled outlets",
formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    parser.add_argument("--port", type=str, default="/dev/ttyACM0", help="port that arduino is connected")
